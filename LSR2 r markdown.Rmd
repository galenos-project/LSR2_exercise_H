...
There was no significant difference in PTSD symptom severity between studies with moderate intensity and those with high intensity exercise groups (see Figure 3). However, visual inspection of the forest plot suggests the effect is larger in the high intensity exercise subgroup.
...
The were no significant difference in PTSD symptom severity between studies of aerobic exercise, anaerobic exercise, or mixed (see Figure 4).
...
The forest plot below shows the meta-analysis results of the primary outcome ordered by the precision of the studies is presented in Figure 8. It seems that smaller studies showed larger effects favouring the intervention.
...
```{r echo=F, warning=F, fig.height=15}
