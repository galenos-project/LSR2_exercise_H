...
The specific intervention and comparison groups for the included studies `r length(table(data_2023_12_4_LSR2_Awks2$studyN))+length(table(LSR2weeksStata2insufdata$studyN))`(`r length(table(LSR2_interventions_150224$study))` comparisons) are presented in table 3. 
