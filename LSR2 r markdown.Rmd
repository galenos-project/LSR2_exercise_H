...
The specific intervention and comparison groups for the `r length(table(data_2023_12_4_LSR2_Awks2$studyN))+length(table(LSR2weeksStata2insufdata$studyN))` eligible studies (`r length(table(LSR2_interventions_150224$study))` comparisons) [**WRONG NUMBERS: DOUBLE CHECK inline code**]{style="color:red"} are presented in Table 3.
