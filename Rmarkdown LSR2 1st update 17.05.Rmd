...
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
|    Overall effect     |            *-*             | `r round(outcome_ptsd_meanchange_ma$TE.random, 2)` | `r round(outcome_ptsd_meanchange_ma$lower.random, 2)` to `r round(outcome_ptsd_meanchange_ma$upper.random, 2)` | `r round(outcome_ptsd_meanchange_ma$tau2, 2)` |
|  Exercise intensity   |            *-*             |                         \-                         |                                                       \-                                                       |                     \-                     |
...
outcome_ptsdma_sensitivity_rob = metacont(PTSD3_posttest_n_tg, ptsd3_meanchange_tg, ptsd3_sdchange_tg, 
                                          PTSD3_posttest_n_cg, ptsd3_meanchange_cg, ptsd3_sdchange_cg, 
