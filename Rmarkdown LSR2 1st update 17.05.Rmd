...
The meta-analysis found some evidence of a difference in PTSD symptom severity reduction between exercise and comparison groups (`r paste0(outcome_ptsd_meanchange_ma$sm, " = ", round(outcome_ptsd_meanchange_ma$TE.random, 2), ", 95% CI ", round(outcome_ptsd_meanchange_ma$lower.random, 2), " to ", round(outcome_ptsd_meanchange_ma$upper.random, 2))`). A τ² of `r round(outcome_ptsd_meanchange_ma$tau2, 4)` and the prediction interval indicate the presence of between-study heterogeneity in the effect sizes.
...
Small-study effects were assessed using Egger's regression test for funnel plot asymmetry. The test suggested potential asymmetry in the funnel plot (p-value = .095) although the contour-enhanced funnel plot does not indicate publication bias as a source for it. The estimated bias coefficient was `r round(egger$estimate, 2)`, indicating that smaller studies may be associated with larger effect sizes.
